...
{
    public partial class SP_ImportPatientByBatch_v2 : Migration
    {
			...
			begin
				...
				begin
					insert medication (
						...
						@patientId, @rxNumber, @refillNumber, @refillsRemaining, @dateFilled, @dispensedItemName, nullif(@drugGenericName, ''), @directions, @dispensedQuantity, @daysSupply
