...
{
    public partial class SP_ImportPatientByBatch_v7 : Migration
    {
...
begin
	...
	begin
		...
		begin try
			...
			begin
				...
				begin
					...
					if @isPdcMedication = 1 and @refillDue = 1 and dateadd(D, -5, @nextFillDate) >= @now
					begin
		...
		select
			...
			, @isPdcMedication = 0, @drugSbdcName = null, @refillDue = null, @previousFillId = null, @scheduledRefillDate = null, @inUse = null
