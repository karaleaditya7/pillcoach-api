...
namespace OntrackDb.Entities
{
    ...
    internal class MedicationReconciliationConfiguration : IEntityTypeConfiguration<MedicationReconciliation>
    {
        public void Configure(EntityTypeBuilder<MedicationReconciliation> builder)
        {
