...
namespace OntrackDb.Migrations
{
    ...
    [Migration("20240207163631_medication-staging-table-primarythirdparty-primarythirdpartybin-column-added")]
    partial class medicationstagingtableprimarythirdpartyprimarythirdpartybincolumnadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OntrackDb.Authentication.User", b =>
                {
                    ...
                    b.Property<DateTime?>("PasswordSetDateUTC")
                        .HasColumnType("datetime2")
                        .HasColumnName("passwordSetDateUTC");
                    ...
                    b.Property<DateTime?>("TwilioNumberAssignedOnUtc")
                        .HasColumnType("datetime2")
                        .HasColumnName("twilioNumberAssignedOnUtc");
            ...
            modelBuilder.Entity("OntrackDb.Entities.CmrVaccine", b =>
                {
                    ...
                    b.Property<int?>("servicetakeawaynformationId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("servicetakeawaynformationId");
            ...
            modelBuilder.Entity("OntrackDb.Entities.Contact", b =>
                {
                    ...
                    b.Property<bool?>("ConsentForBirthdaySms")
                        .HasColumnType("bit")
                        .HasColumnName("consentForBirthdaySms");
            ...
            modelBuilder.Entity("OntrackDb.Entities.ImportFileStagingData", b =>
                {
                    ...
                    b.Property<string>("DrugSbdcName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PrimaryThirdParty")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PrimaryThirdPartyBin")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OntrackDb.Entities.Medication", b =>
                {
                    ...
                    b.Property<DateTime?>("ConsumptionEndDate")
                        .HasColumnType("datetime2")
                        .HasColumnName("consumptionEndDate");
                    ...
                    b.Property<string>("PrimaryThirdParty")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("primaryThirdParty");

                    b.Property<string>("PrimaryThirdPartyBin")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("primaryThirdPartyBin");

                    b.Property<int>("Quantity")
                        .HasColumnType("int")
                        .HasColumnName("quantity");

                    b.Property<bool>("RefillDue")
                        .HasColumnType("bit")
                        .HasColumnName("refillDue");
            ...
            modelBuilder.Entity("OntrackDb.Entities.MedicationCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OntrackDb.Entities.Patient", b =>
                {
                    ...
                    b.Property<bool>("CholesterolRefillDue")
                        .HasColumnType("bit")
                        .HasColumnName("cholesterolRefillDue");

                    b.Property<int?>("ContactId")
                        .HasColumnType("int");

                    b.Property<bool>("DiabetesRefillDue")
                        .HasColumnType("bit")
                        .HasColumnName("diabetesRefillDue");
                    ...
                    b.Property<bool>("RasaRefillDue")
                        .HasColumnType("bit")
                        .HasColumnName("rasaRefillDue");
                    ...
                    b.Property<int?>("primaryThirdPartyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("primaryThirdPartyId");
            ...
            modelBuilder.Entity("OntrackDb.Entities.Pharmacy", b =>
                {
                    ...
                    b.Property<string>("TwilioSmsNumber")
                        .HasMaxLength(15)
                        .IsUnicode(false)
                        .HasColumnType("varchar(15)")
                        .HasColumnName("twilioSmsNumber");
            ...
            modelBuilder.Entity("OntrackDb.Entities.PrimaryThirdParty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OrganizationMarketingName")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("organizationMarketingName");

                    b.HasKey("Id");

                    b.ToTable("primaryThirdParty");
                });
            ...
            modelBuilder.Entity("OntrackDb.Entities.RefillDueActivationQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RefillDueActivationQueue");
                });
            ...
            modelBuilder.Entity("OntrackDb.Entities.RxNavMedication", b =>
                {
                    ...
                    b.HasIndex("GenericName")
                        .HasDatabaseName("IX_GenericName");

                    b.HasIndex("SBDCName")
                        .HasDatabaseName("IX_SBDCName");
            ...
            modelBuilder.Entity("OntrackDb.Entities.UserPasswordHistory", b =>
                {
                    b.Property<string>("UserID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("OntrackDb.Entities.ImportSourceFile", b =>
                {
                    b.HasOne("OntrackDb.Entities.ImportFileStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("OntrackDb.Entities.MedicationConsumption", b =>
                {
                    b.HasOne("OntrackDb.Entities.Medication", null)
                        .WithMany()
                        .HasForeignKey("MedicationId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("OntrackDb.Entities.Patient", b =>
                {
                    ...
                    b.HasOne("OntrackDb.Entities.PrimaryThirdParty", "primaryThirdParty")
                        .WithMany()
                        .HasForeignKey("primaryThirdPartyId");
                    ...
                    b.Navigation("primaryThirdParty");
                });
            ...
            modelBuilder.Entity("OntrackDb.Entities.UserPasswordHistory", b =>
                {
                    b.HasOne("OntrackDb.Authentication.User", "AppUser")
