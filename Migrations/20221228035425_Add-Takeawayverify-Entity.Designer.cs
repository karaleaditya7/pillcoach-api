...
namespace OntrackDb.Migrations
{
    ...
    [Migration("20221228035425_Add-Takeawayverify-Entity")]
    partial class AddTakeawayverifyEntity
    {
            ...
            modelBuilder.Entity("OntrackDb.Entities.Allergy", b =>
                {
                    ...
                    b.HasIndex("medicationSubstanceId")
                        .IsUnique()
                        .HasFilter("[medicationSubstanceId] IS NOT NULL");
            ...
            modelBuilder.Entity("OntrackDb.Entities.Allergy", b =>
                {
                    ...
                    b.HasOne("OntrackDb.Entities.MedicationSubstance", "MedicationSubstance")
                        .WithOne()
                        .HasForeignKey("OntrackDb.Entities.Allergy", "medicationSubstanceId")
            ...
            modelBuilder.Entity("OntrackDb.Entities.SideEffect", b =>
                {
                    ...
                    b.HasOne("OntrackDb.Entities.MedicationSubstance", "MedicationSubstance")
                        .WithOne()
                        .HasForeignKey("OntrackDb.Entities.SideEffect", "medicationSubstanceId")
                        .OnDelete(DeleteBehavior.ClientCascade);
