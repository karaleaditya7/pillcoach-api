...
{
    public partial class SP_ImportPatientByBatch_v6 : Migration
    {
...
begin
	...
	declare
		...
		, @previousFillId int, @scheduledRefillDate date
	...
	begin
		...
		select
			...
			, @isPdcMedication = 0, @drugSbdcName = null, @refillDue = null, @previousFillId = null, @scheduledRefillDate = null
