...
namespace OntrackDb.Migrations
{
    ...
    [Migration("20220908074458_Added-Property-SBDCName-To-CmrMedication")]
    partial class AddedPropertySBDCNameToCmrMedication
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OntrackDb.Entities.MedicationRelated", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("medicationRelated");
                });

            modelBuilder.Entity("OntrackDb.Entities.MedicationToDoList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("medicationToDoList");
                });

            modelBuilder.Entity("OntrackDb.Entities.MedicationToDoListNonRelated", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MedicationRelatedId")
                        .HasColumnType("int");

                    b.Property<int?>("MedicationToDoListId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("MedicationRelatedId");

                    b.HasIndex("MedicationToDoListId");

                    b.ToTable("medicationToDoListNonRelated");
                });

            modelBuilder.Entity("OntrackDb.Entities.MedicationToDoListRelated", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("medicationToDoListRelated");
                });
            ...
            modelBuilder.Entity("OntrackDb.Entities.MedicationToDoListNonRelated", b =>
                {
                    b.HasOne("OntrackDb.Entities.MedicationRelated", "MedicationRelated")
                        .WithMany()
                        .HasForeignKey("MedicationRelatedId");

                    b.HasOne("OntrackDb.Entities.MedicationToDoList", "MedicationToDoList")
                        .WithMany()
                        .HasForeignKey("MedicationToDoListId");

                    b.Navigation("MedicationRelated");

                    b.Navigation("MedicationToDoList");
                });
