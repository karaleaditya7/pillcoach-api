...
{
    public partial class SP_ImportPatientByBatch_v4 : Migration
    {
...
begin
	...
	declare
		...
		, @dispensedItemName nvarchar(max), @directions nvarchar(max), @patientPaidAmount decimal(18, 2), @isPdcMedication bit, @drugSbdcName nvarchar(max)
	...
	begin
			...
			begin
				...
				begin
					insert medication (
						...
						, 1, 1, 0, @nextFillDate, @drugSbdcName
					)
		...
		select
			...
			, @isPdcMedication = 0, @drugSbdcName = null
